        ...
        <div>
            {!isChatOpen ? (
                <div className="relative bg-gray-200  overflow-x-hidden  ">
                    <Navbar />
                    <div className="relative p-5  flex  items-center justify-center h-[60vh] mt-30 xl:mt-0 xl:h-screen w-screen">
                        <div className="relative h-[90%] w-full xl:h-[75%] xl:w-[70%] rounded-xl shadow-xl overflow-hidden">
                            <img
                                className="h-full w-full object-cover"
                                src="https://cdn.pixabay.com/photo/2024/03/13/19/06/ai-generated-8631634_1280.jpg"
                                alt=""
                            />
                            <div className="absolute  inset-0 bg-transparent bg-opacity-20 backdrop-blur-md border border-[#F97316] border-opacity-20 rounded-xl w-[80%] sm:h-[50%] sm:w-[60%] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-5 flex flex-col items-start justify-center">
                    ...
                    <div className="sm:h-auto  mb-15 ">
                        <h1 className="text-[#F97316] text-center text-3xl sm:text-5xl 2xl:text-7xl font-bold font-serif">
